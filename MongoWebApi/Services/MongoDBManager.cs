...
namespace MongoWebApi.Services
{
    public class MongoDBManager
    {
        ...
        //public void EditColumnName(string dbName, string tableName, string columnName, string newColumnName)
        //{
        //    IMongoCollection<Column> collection = _client.GetDatabase(dbName).GetCollection<Column>(tableName);
        //    try
        //    {
        //        Column a = collection.Find(x => x.ColumnName == columnName).First();
        //        EnumColumn s;
        //        Column res;
        //        if(a.ColumnType == "Enum")
        //        {
        //            s = (EnumColumn)a;
        //            res = CreateColumn(newColumnName, s.ColumnType, s.enumValues);
        //            res.elements = s.elements;
        //        }
        //        else
        //        {
        //            res = CreateColumn(newColumnName, a.ColumnType);
        //            res.elements = a.elements;
        //        }
        //        collection.repl
        //        collection.FindOneAndReplace(x => x.ColumnName == columnName, res);
        //        return;
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //private Column toChildColumn(Column a)
        //{
        //    switch (a.ColumnType)
        //    {
        //        case "Int":
        //            IntegerColumn i = (IntegerColumn)a;
        //            return i;
        //        case "Real":
        //            RealColumn r = (RealColumn)a;
        //            return r;
        //        case "Char":
        //            CharColumn c = (CharColumn)a;
        //            return c;
        //        case "Email":
        //            EmailColumn e = (EmailColumn)a;
        //            return e;
        //        case "String":
        //            StringColumn s = (StringColumn)a;
        //            return s;
        //        case "Enum":
        //            EnumColumn en = (EnumColumn)a;
        //            return en;
        //        default:
        //            return null;
        //    }
